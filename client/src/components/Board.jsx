  ...
  if (!board) {
    return (
      <div className="h-full flex flex-col">
        ...
        <header
          className={`px-4 py-4 pt-10 lg:pt-4 border-b flex items-center gap-4 ${
        ...
        >
          ...
          <svg className="w-8 h-8" viewBox="0 0 100 100">
            ...
            <path
              d="M20 25 Q35 35, 35 50 Q35 65, 50 75"
            ...
            />
            <path
              d="M50 20 Q50 35, 50 50 Q50 65, 50 80"
              stroke="url(#headerLogoGrad)"
              strokeWidth="8"
              strokeLinecap="round"
              fill="none"
            ...
            />
            <path
              d="M80 25 Q65 35, 65 50 Q65 65, 50 75"
              stroke="url(#headerLogoGrad)"
              strokeWidth="8"
              strokeLinecap="round"
              fill="none"
    ...
    <div className="h-full flex flex-col">
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          <h2 className="text-xl sm:text-2xl font-mono font-bold truncate">
            {board.name}
          </h2>
          <p
                ...
                {archivedCards.map((card) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {totalCount > 0 && (
                        <div
                          className={`flex items-center gap-1 mb-2 text-[10px] ${
                            theme === "dark" ? "text-gray-500" : "text-gray-400"
                          }`}
                        >
                          <svg
                      ...
                      <div className="flex gap-2">
                        ...
                        <button
                          ...
                          className={`px-2 py-1.5 rounded-lg font-mono text-xs text-red-400 ${
                            theme === "dark"
                              ? "hover:bg-red-500/10"
                              : "hover:bg-red-50"
                          }`}
