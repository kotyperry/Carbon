  ...
  return (
    ...
    >
      ...
      <div className="flex items-start justify-between gap-2">
        <h4
          className={`font-mono text-sm font-medium flex-1 line-clamp-2 ${
      ...
      {bookmark.description && (
        <p
          className={`text-xs line-clamp-2 mt-1 mb-2 ${
